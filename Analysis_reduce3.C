...
void Analysis_reduce3()
{
  ...
  if(simuFlag)
    {
      //TFile *f = new TFile("./output/Output_100MeV_He4_He4.root");
      //TFile *f = new TFile("./output/Output_40MeV_He3He3_He4He4_noPolya.root");
      TFile *f = new TFile("./output/Output_40MeV_He3He3_He4He4_iongasmod.root");
      //TFile *f = new TFile("./output/Output_40MeV_He3He3_He4He4.root");
      //TFile *f = new TFile("./output/Output_40MeV_He3_He3.root");
      //TFile *f = new TFile("./output/Output_40MeV_He4_He4.root");
      //TFile *f = new TFile("./output/Output_40MeV_He4_He4.root");
      //TFile *f = new TFile("./output/Output_60MeV_He4_He4.root");
      //TFile *f = new TFile("./output/Output_60MeV_12C_He4.root");
      //TFile *f = new TFile("./output/Output_80MeV_13C_He4.root");
      //TFile *f = new TFile("./output/Output_80MeV_He4.root");
      //TFile *f = new TFile("./output/Output_80MeV_He3.root");
      //TFile *f = new TFile("./output/Output_all3.root");       
      //TFile *f = new TFile("./output/Output_test.root");    
