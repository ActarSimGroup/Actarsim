...
ActarSimParticlesBuilder::ActarSimParticlesBuilder(const G4String& name)
   :  G4VPhysicsConstructor(name){}


ActarSimParticlesBuilder::~ActarSimParticlesBuilder(){}


void ActarSimParticlesBuilder::ConstructParticle() {
  //
